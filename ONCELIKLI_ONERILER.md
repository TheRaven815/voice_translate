...
- [ ] **VU hâlâ kuyrukta; `last_level` okunmuyor**
...
- [ ] **CLI `input()` Windows’ta her şeyi kilitler**
...
- [ ] **CLI çıkışta `ExceptionGroup` traceback**
...
- [ ] **CLI ürün olarak GUI’nin gerisinde**
...
- [ ] **Dil kodları config’de UI Türkçe adı**
...
- [ ] **Pencere ve altyazı geometrisi kayboluyor**
...
- [ ] **Select klavye ile kullanılamıyor**
...
- [ ] **48 kHz varsayımı ve kutu-ortalama downsample**
...
- [ ] **`receive` ses gelince transkripti atlayabilir**
...
- [ ] **Bağlantı hataları kullanıcı diline çevrilmiyor**
...
- [ ] **Çalışırken dil/aygıt değiştirilemiyor (yeniden bağlanma yok)**
...
- [ ] **`ahenk.bat` her açılışta `pip install`**
...
- [ ] **Onefile exe CLI’yi içermiyor; UPX + deprecated PyInstaller kwargs**
